                ...
                <div class="col-md-12 block-advert-site" style="text-align: center;">
                    ...
                    @if(isset($user['id_group']))
                        <div class="row" style="padding: 0 20px 0 20px; margin-top: 20px;">
                            <div class="hover-shadow add-partner" id="{{$project->id_business_proj}}" style="font-size: 16px; cursor: pointer; height: auto; background: #fff; color: #999; border: 1px solid #cecece; padding: 7px; margin-top: 0px;">
                    ...
                    <div class="row" style="padding: 20px 20px 0 20px;">
                        <div class="hover-shadow show-phone phone-{{$project->id_business_proj}}" id="{{$project->id_business_proj}}" style="font-size: 16px; cursor: pointer; height: auto; background: #fff; color: #039ad3; border: 1px solid #039ad3; padding: 7px; margin-top: 0px;">
                    ...
                    <div class="row" style="padding: 20px 20px 0 20px; margin-bottom: 20px;">
                        <div class="hover-shadow send-message" id="{{$project->id_business_proj}}" style="font-size: 16px; cursor: pointer; height: auto; background: #5cb85c; color: #fff; border: 1px solid #039ad3; padding: 7px; margin-top: 0px;">
                            Написать владельцу&nbsp;<i style="margin-left: 5px;" class="glyphicon glyphicon-comment"></i>
                        </div>
                    </div>
                </div>
