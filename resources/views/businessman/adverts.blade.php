...
@section('content')
    ...
    <div class="row setting-row" style="padding: 0 10px 0 10px;">
        @if(isset($projects[0]->id_business_proj))
            ...
            <div class="tab-content">
                <div id="activ-adverts" class="tab-pane fade in active">
                    ...
                    @foreach($projects as $project_row)
                        @if($project_row->status_business_proj == 1)
                            <?php
                            $bg = ($project_row->type_business_proj == 0) ? '#FFFFFF;' : '#FFFFE4;';
                            $border = ($project_row->type_business_proj == 0) ? '#F1F1F1;' : '#CECECE;';
                            ?>
                            <div class="col-md-12" style="margin-bottom: 20px; text-align: center;">
                                <div class="row" style="border: 1px solid <?=$border; ?> margin-bottom: 20px; background: <?=$bg; ?>">
                                    <div class="col-md-12">
                                        <div style="margin: 10px 0 10px 0;">
                                            <a style="font-size: 20px;" href="/profile/adverts/{{$project_row->id_business_proj}}">{{$project_row->title_business_proj}}</a>
                                        </div>
                                    </div>
                                    <div class="col-md-6" style="border-right: 1px solid <?=$border; ?>">
                                        <?php
                                            $images1 = json_decode($project_row->img_business_proj);
                                        ?>
                                        <img src="<?=$images1[0]; ?>" style="width: 100%; margin-bottom: 15px;">
                                    </div>
                                    <div class="col-md-6">
                                        <div class="row">
                                            <div class="col-md-6" style="text-align: right;">Просмотров:</div>
                                            <div class="col-md-6" style="text-align: left;">{{$project_row->views_business_proj}}</div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6" style="text-align: right;">Откликов:</div>
                                            <div class="col-md-6" style="text-align: left;">{{$project_row->feedbacks_business_proj}}</div>
                                        </div>
                                        ...
                                        <div class="row" style="margin: 10px 0 10px 0;">
                                            <div class="col-md-12" style="padding-top: 15px;">
                                                ...
                                                <i class="glyphicon glyphicon-trash arhives-advert" id="{{$project_row->id_business_proj}}" style="margin-right: 20px; font-size: 19px; color: red; cursor: pointer;" data-toggle="tooltip" data-placement="bottom" title="В архив" data-original-title="В архив"></i>
                                                @if($project_row->type_business_proj == 0)
                ...
                <div id="unactiv-adverts" class="tab-pane fade">
                    ...
                    @foreach($projects as $project_row)
                        @if($project_row->status_business_proj == 0 OR $project_row->status_business_proj > 2)
                            <?php
                            $bg = ($project_row->type_business_proj == 0) ? '#FFFFFF;' : '#FFFFE4;';
                            $border = ($project_row->type_business_proj == 0) ? '#F1F1F1;' : '#CECECE;';
                            ?>
                            <div class="col-md-12" style="margin-bottom: 20px; text-align: center;">
                                <div class="row" style="border: 1px solid <?=$border; ?> margin-bottom: 20px; background: <?=$bg; ?>">
                                    ...
                                    <div class="col-md-6" style="border-right: 1px solid <?=$border; ?>">
                                        <?php
                                            $images2 = json_decode($project_row->img_business_proj);
                                        ?>
                                        <img src="<?=$images2[0]; ?>" style="width: 100%; margin-bottom: 15px;">
                                    </div>
                                    <div class="col-md-6">
                                        <div class="row">
                                            <div class="col-md-6" style="text-align: right;">Просмотров:</div>
                                        ...
                                        <div class="row" style="margin: 10px 0 10px 0;">
                                            @if($project_row->status_business_proj == 0)
                                                <div class="col-md-12" style="padding-top: 8px;">
                                                    <a style="text-decoration: none; font-size: 20px;" href="/profile/adverts/{{$project_row->id_business_proj}}">
                                                        <i class="glyphicon glyphicon-cog" style="font-size: 19px;"></i>
                                                    </a>
                                                    <i style="margin-right: 20px;"></i>
                                                    <i class="glyphicon glyphicon-trash arhives-advert" id="{{$project_row->id_business_proj}}" style="font-size: 19px; color: red; cursor: pointer;" data-toggle="tooltip" data-placement="bottom" title="В архив" data-original-title="В архив"></i>
                                                    <i style="margin-right: 20px;"></i>
                                                    <a style="border: 1px solid #cecece; padding: 10px 10px 8px 10px; text-decoration: none; font-size: 20px; color: #666666;" href="/profile/payment/{{$project_row->id_business_proj}}">
                ...
                <div id="arhives-adverts" class="tab-pane fade">
                    ...
                    @foreach($projects as $project_row)
                        @if($project_row->status_business_proj == 2)
                            <?php
                            $bg = ($project_row->type_business_proj == 0) ? '#FFFFFF;' : '#FFFFE4;';
                            $border = ($project_row->type_business_proj == 0) ? '#F1F1F1;' : '#CECECE;';
                            ?>
                            <div class="col-md-12" style="margin-bottom: 20px; text-align: center;">
                                <div class="row" style="border: 1px solid <?=$border; ?> margin-bottom: 20px; background: <?=$bg; ?>">
                                    ...
                                    <div class="col-md-6" style="border-right: 1px solid <?=$border; ?>">
                                        <?php
                                            $images3 = json_decode($project_row->img_business_proj);
                                        ?>
                                        <img src="<?=$images3[0]; ?>" style="width: 100%; margin-bottom: 15px;">
                                    </div>
                                    <div class="col-md-6">
                                        <div class="row">
                                            <div class="col-md-6" style="text-align: right;">Просмотров:</div>
                                        ...
                                        <div class="row" style="margin: 10px 0 10px 0;">
                                            <div class="col-md-12" style="padding-top: 15px;">
                                                <i id="{{$project_row->id_business_proj}}" class="glyphicon glyphicon-play-circle replay-advert" title="Возобновить" style="font-size: 22px; margin-right: 20px; color: green; cursor: pointer;"></i>
