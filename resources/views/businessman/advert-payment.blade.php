...
@section('content')
    ...
    <script src="{{ url('public/js/payment-advert-businessman.js') }}" rel="script" type="text/javascript"></script>
                ...
                <div id="block-pre-advert" class="row" style="border: 1px solid <?=$border; ?> margin-bottom: 20px; background: <?=$bg; ?>">
                    <div class="col-md-12">
                        <div style="margin: 10px 0 10px 0; display: inline-block; font-size: 20px; padding: 7px; color: #666666;">
                            {{$projects->title_business_proj}}
                        </div>
                    </div>
                    <div class="col-md-6" style="border-right: 1px solid <?=$border; ?>">
                        @if(isset($projects->img_business_proj))
                            <?php
                            $images1 = json_decode($projects->img_business_proj);
                            ?>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="row" style="margin: 10px 0 10px 0;">
                            <div class="col-md-12" style="padding-top: 15px;">
                                <span style="font-weight: bold; font-size: 25px;" id="sum-pay-advert">749</span>
                    ...
                    <div class="col-md-4">
                        <div id="block-type-advert-3" class="block-type-advert" style="border: 1px solid #cecece; padding: 10px 0 10px 0;">
                            ...
                            <div style="margin-top: 10px;">
                                <span style="font-weight: bold; font-size: 25px;">250</span>
                                <i class="glyphicon glyphicon-rub" style="font-size: 19px; color: green;"></i>
                            </div>
                            <div name="250" class="btn btn-default type-advert-selet" id="3" style="margin-top: 10px;">Выбрать</div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div id="block-type-advert-2" class="block-type-advert" style="border: 1px solid green; background: #fffff1; padding: 10px 0 10px 0;">
                            ...
                            <div style="margin-top: 10px;">
                                <span style="font-weight: bold; font-size: 25px;">490</span>
                                <i class="glyphicon glyphicon-rub" style="font-size: 19px; color: green;"></i>
                            </div>
                            ...
                            <div name="490" class="btn btn-default type-advert-selet" id="2" style="margin-top: 10px;">Выбрать</div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div id="block-type-advert-1" class="block-type-advert" style="border: 1px solid red; background: #FFFFCC; padding: 10px 0 10px 0;">
                            ...
                            <div style="margin-top: 10px;">
                                <span style="font-weight: bold; font-size: 25px;">749</span>
                                <i class="glyphicon glyphicon-rub" style="font-size: 19px; color: green;"></i>
                            </div>
                            <div style="margin-top: 10px; font-size: 12px; text-align: left;">
                                <ul style="padding: 0 0 0 18px;">
                            ...
                            <div name="749" class="btn btn-default type-advert-selet" id="1" style="margin-top: 10px;">Выбрать</div>
                        </div>
                    </div>
                </div>
