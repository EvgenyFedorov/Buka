$(document).ready(function(){
    ...
    $('#send-message-businessman').click(function () {
        ...
        if($('#message').val() == ""){
            ...
            $.ajax({
                url: '../../api/adverts/send-dialog-businessman',
                type: "POST",
                data: {
                    _token: $('#_token').val(),
    ...
    $('.show-phone').click(function () {
        ...
        $.ajax({
            url: '../../api/adverts/show-phone-businessman',
            type: "POST",
            data: {
                _token: $('#_token').val(),
    ...
    $('#add-advert-business').click(function () {
        ...
        if($('#activity').val() == ""){
        ...
        }else if($('#sum-profit').val() == ""){

            $('#sum-profit').focus();
            $('#sum-profit').css('border', '1px solid #ff0000');

        }else if($('#sum-turn').val() == ""){

            $('#sum-turn').focus();
            $('#sum-turn').css('border', '1px solid #ff0000');

        }else if($('#sum-expe').val() == ""){

            $('#sum-expe').focus();
            $('#sum-expe').css('border', '1px solid #ff0000');

        }else if($('#sum-proportion').val() == ""){

            $('#sum-proportion').focus();
            $('#sum-proportion').css('border', '1px solid #ff0000');
            ...
            $.ajax({
                ...
                data: {
                    ...
                    sum_turn: $('#sum-turn').val(),
                    sum_profit: $('#sum-profit').val(),
                    sum_expe: $('#sum-expe').val(),
                    sum_proportion: $('#sum-proportion').val(),
    ...
    $('#update-advert-business').click(function () {
